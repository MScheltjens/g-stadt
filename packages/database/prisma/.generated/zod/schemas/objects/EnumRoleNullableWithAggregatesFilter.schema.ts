...
const makeSchema = () =>
  z
    ...
    .strict();
export const EnumRoleNullableWithAggregatesFilterObjectSchema: z.ZodType<Prisma.EnumRoleNullableWithAggregatesFilter> =
  makeSchema() as unknown as z.ZodType<Prisma.EnumRoleNullableWithAggregatesFilter>;
