...
const makeSchema = () =>
  z
    ...
    .strict();
export const ServiceUncheckedCreateWithoutCategoryInputObjectSchema: z.ZodType<Prisma.ServiceUncheckedCreateWithoutCategoryInput> =
  makeSchema() as unknown as z.ZodType<Prisma.ServiceUncheckedCreateWithoutCategoryInput>;
export const ServiceUncheckedCreateWithoutCategoryInputObjectZodSchema =
  makeSchema();
