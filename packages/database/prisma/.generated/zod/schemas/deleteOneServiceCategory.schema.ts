...
export const ServiceCategoryDeleteOneSchema: z.ZodType<Prisma.ServiceCategoryDeleteArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.ServiceCategoryDeleteArgs>;

export const ServiceCategoryDeleteOneZodSchema = z
  .object({
    select: ServiceCategorySelectObjectSchema.optional(),
    include: ServiceCategoryIncludeObjectSchema.optional(),
    where: ServiceCategoryWhereUniqueInputObjectSchema,
