...
export const ServiceTranslationFindFirstSelectSchema: z.ZodType<Prisma.ServiceTranslationSelect> =
  z
    .object({
...
export const ServiceTranslationFindFirstSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    serviceId: z.boolean().optional(),
    locale: z.boolean().optional(),
...
export const ServiceTranslationFindFirstSchema: z.ZodType<Prisma.ServiceTranslationFindFirstArgs> =
  z
    .object({
      select: ServiceTranslationFindFirstSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.ServiceTranslationFindFirstArgs>;

export const ServiceTranslationFindFirstZodSchema = z
  .object({
    select: ServiceTranslationFindFirstSelectSchema.optional(),
    include: z.lazy(() => ServiceTranslationIncludeObjectSchema.optional()),
    orderBy: z
