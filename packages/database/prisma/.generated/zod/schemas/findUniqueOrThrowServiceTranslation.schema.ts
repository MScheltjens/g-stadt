...
export const ServiceTranslationFindUniqueOrThrowSchema: z.ZodType<Prisma.ServiceTranslationFindUniqueOrThrowArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.ServiceTranslationFindUniqueOrThrowArgs>;

export const ServiceTranslationFindUniqueOrThrowZodSchema = z
  .object({
    select: ServiceTranslationSelectObjectSchema.optional(),
    include: ServiceTranslationIncludeObjectSchema.optional(),
    where: ServiceTranslationWhereUniqueInputObjectSchema,
