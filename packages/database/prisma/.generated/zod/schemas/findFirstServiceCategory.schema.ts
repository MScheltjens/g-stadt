...
export const ServiceCategoryFindFirstSelectSchema: z.ZodType<Prisma.ServiceCategorySelect> =
  z
    .object({
...
export const ServiceCategoryFindFirstSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    order: z.boolean().optional(),
...
export const ServiceCategoryFindFirstSchema: z.ZodType<Prisma.ServiceCategoryFindFirstArgs> =
  z
    .object({
      select: ServiceCategoryFindFirstSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.ServiceCategoryFindFirstArgs>;

export const ServiceCategoryFindFirstZodSchema = z
  .object({
    select: ServiceCategoryFindFirstSelectSchema.optional(),
    include: z.lazy(() => ServiceCategoryIncludeObjectSchema.optional()),
    orderBy: z
