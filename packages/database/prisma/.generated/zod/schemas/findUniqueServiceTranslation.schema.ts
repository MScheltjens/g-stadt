...
export const ServiceTranslationFindUniqueSchema: z.ZodType<Prisma.ServiceTranslationFindUniqueArgs> =
  z
    .object({
    ...
    .strict() as unknown as z.ZodType<Prisma.ServiceTranslationFindUniqueArgs>;

export const ServiceTranslationFindUniqueZodSchema = z
  .object({
    select: ServiceTranslationSelectObjectSchema.optional(),
    include: ServiceTranslationIncludeObjectSchema.optional(),
    where: ServiceTranslationWhereUniqueInputObjectSchema,
