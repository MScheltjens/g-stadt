...
export const ServiceFindManySelectSchema: z.ZodType<Prisma.ServiceSelect> = z
  .object({
...
export const ServiceFindManySelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    categoryId: z.boolean().optional(),
    category: z.boolean().optional(),
...
export const ServiceFindManySchema: z.ZodType<Prisma.ServiceFindManyArgs> = z
  .object({
    select: ServiceFindManySelectSchema.optional(),
