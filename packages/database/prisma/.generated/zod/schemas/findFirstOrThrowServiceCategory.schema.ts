...
export const ServiceCategoryFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ServiceCategorySelect> =
  z
    .object({
...
export const ServiceCategoryFindFirstOrThrowSelectZodSchema = z
  .object({
    id: z.boolean().optional(),
    code: z.boolean().optional(),
    order: z.boolean().optional(),
...
export const ServiceCategoryFindFirstOrThrowSchema: z.ZodType<Prisma.ServiceCategoryFindFirstOrThrowArgs> =
  z
    .object({
      select: ServiceCategoryFindFirstOrThrowSelectSchema.optional(),
    ...
    .strict() as unknown as z.ZodType<Prisma.ServiceCategoryFindFirstOrThrowArgs>;

export const ServiceCategoryFindFirstOrThrowZodSchema = z
  .object({
    select: ServiceCategoryFindFirstOrThrowSelectSchema.optional(),
    include: z.lazy(() => ServiceCategoryIncludeObjectSchema.optional()),
    orderBy: z
